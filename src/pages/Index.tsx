    ...
    <div className="min-h-screen bg-gradient-night speed-lines">
      ...
      <div className="container mx-auto px-4 py-12 lg:py-20 pt-24">
        ...
        >
          ...
          <div className="flex flex-nowrap justify-center gap-6 max-w-2xl mx-auto overflow-x-auto px-2">
            {[
              "C++",
              "Python",
              "JavaScript",
              ...
              <span
                key={lang}
                className="relative px-3 py-1 text-xs font-mono rounded-full bg-muted/50 text-muted-foreground border border-border hover:border-primary hover:text-primary transition-colors cursor-default after:content-[''] after:absolute after:top-1/2 after:-right-3 after:w-4 after:h-px after:bg-border/70 last:after:hidden"
              >
                {lang}
              </span>
            ))}
